...
- Hyndman, R.J. & Athanasopoulos, G. (2018). *Forecasting: Principles and Practice* (2da ed.). OTexts. Disponible en [https://otexts.com/fpp2/](https://otexts.com/fpp2/)
...
- R Documentation. HoltWinters() y forecast packages: https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/HoltWinters
